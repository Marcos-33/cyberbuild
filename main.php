<!-- 
Pagina principal, basicamente el index si se ha iniciado sesion.
Esta pagina existe para aceptar la ausencia creada por un profesor.
-->
<?php
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li class="pina"><a href="personal.php">Panel Personal</a></li>
            <li class="pina"><a href="clases.php">añadir clases(?)</a></li>
        </ul>
    </nav>
    <main>
        <?php
    ...
    // Hacemos una cosulta para obtener las ausencias diarias que los administradores 
    // han aceptado pero nadie la ha cubierto todavia.
    ...
    if ($resultado_ausencia && $resultado_ausencia->num_rows > 0) {
        while ($away = $resultado_ausencia->fetch_assoc()) {
            echo '<tr>';
                ...
                //  Día (Nueva columna a la izquierda de Clase)
            ...
            // Mensaje que se muestra debajo de la tabla si hay ausencias.
        } else {
